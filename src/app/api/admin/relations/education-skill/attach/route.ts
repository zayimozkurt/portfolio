import { EducationSkillService } from '@/services/relations/education-skill.service';
...
export async function POST(req: NextRequest) {
    try {
        ...
        const validateDtoResponse = await validateDto(AttachOrDetachEducationSkillDto, reqBody);
        ...
        const response = await EducationSkillService.attach(validateDtoResponse.body);
